...
/*
 * if(!$nFrameID) { continue; } /// if($nFrameEnd>$nFrameCount) { $nFrameEnd = $nFrameCount; }
 */
...
foreach ($arCode as $nTVYear => $szPatName)
{
    ...
    // tv2007.devel.lst
    $szFPVideoListFN = sprintf("%s/%s.lst", $szRootMetaDataDir, $szFPPatName);
    ...
    extractKeyFrameForOneList($arBlackList, $arVideoDurationList, $szMetaDataDir, $szRootVideoDir, $szRootKeyFrameDir, $nMaxKFPerShot);
}
// /////////////////////////////////////////// FUNCTIONS ///////////////////////////////////////
function extractKeyFramesForOneVideo($szFPShotBoundaryFN, $szVideoDir, $szMetaDataDir, $szKeyFrameDir, $fSourceFrameRate, $nMaxKFPerShot = 5)
{
    global $szFPErrLogFN;
    ...
    /*
     * 00001-Fujimoristas_invade_Amnisty_International_marathon._-o-_.MOV00010_64kb_512kb TRECVID2011_11645 TRECVID2011_11645.shot11645_1 #$# 0 #$# 243 TRECVID2011_11645.shot11645_2 #$# 243 #$# 3 TRECVID2011_11645.shot11645_3 #$# 246 #$# 186
     */
...
function extractKeyFrameForOneList(&$arBlackList, &$arVideoDurationList, $szMetaDataDir, $szRootVideoDir, $szRootKeyFrameDir, $nMaxKFPerShot = 5)
{
    global $nNormalizeFrameRate;
    global $szVideoPath;
    ...
    foreach ($arBlackList as $szVideoID => $szVideoName)
    {
        ...
        extractKeyFramesForOneVideo($szFPShotBoundaryFN, $szOutputVideoDir, $szMetaDataDir, $szKFOutputDir, $fSourceFrameRate, $nMaxKFPerShot);
    }
}
