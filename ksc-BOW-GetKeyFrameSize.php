...
getKeyFrameSizeForOneList($szFPVideoListFN, $szMetaDataDir, $szRootKeyFrameDir, $nStartVideoID, $nEndVideoID);
...
function getKeyFrameSizeForOneList($szFPVideoListFN, $szRootMetaDataDir, $szRootKeyFrameDir, $nStart = 0, $nEnd = 1)
{
    global $gszDelim;
