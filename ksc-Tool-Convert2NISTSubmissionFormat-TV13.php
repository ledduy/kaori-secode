...
would be appreciated.
     ...
     class - indication of whether the run is a main (M)
single-concept submission a concept-pair (P) run.

     targetYear - the year of the test data used (13 for non-progress
runs; 14 or 15 for progress runs
...
priority only once across all runs you submit.
     ...
     loc - indication of whether a file containing localization
results is associated with this run; the file is specified on the
submission webpage
