...
echo [$HOSTNAME] [$JOB_ID] [ksc-Feature-ExtractBoW-FisherVector-SPM] [$1] [$2] [$3] [$4] [$5] [$6] [$7]
...
/net/per900b/raid0/ledduy/usr.local/bin/php -f ksc-Feature-ExtractBoW-FisherVector-SPM.php $1 "$2" $3 $4 $5 $6 $7
