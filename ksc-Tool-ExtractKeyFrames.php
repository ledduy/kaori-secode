...
extractKeyFrameForOneList($szFPVideoListFN, $szMetaDataDir, $szRootVideoDir, $szRootKeyFrameDir, $nMaxKFPerShot, $nStart, $nEnd);
...
// ///////////////////////////////////////// FUNCTIONS ///////////////////////////////////////////
function extractKeyFramesForOneVideo($szFPShotBoundaryFN, $szVideoDir, $szMetaDataDir, $szKeyFrameDir, $nMaxKFPerShot = 5)
{
    global $arBlackList;
...
function extractKeyFrameForOneList($szFPVideoListFN, $szMetaDataDir, $szRootVideoDir, $szRootKeyFrameDir, $nMaxKFPerShot = 5, $nStart = 0, $nEnd = 1)
{
    global $gszDelim;
    ...
    for ($i = $nStart; $i < $nEnd; $i ++)
    {
        ...
        extractKeyFramesForOneVideo($szFPShotBoundaryFN, $szVideoDir, $szMetaDataDir, $szKFOutputDir, $nMaxKFPerShot);
    }
}
