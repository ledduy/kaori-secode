 ...
 * Ann format: partition --> program --> keyframe.
 * Each is separated by ONE space (' ')
...
/**
 * LibSVM format: Label Index1:Val1 Index2:Val2 .
 * .. IndexN:ValN.
...
/**
 * (Randomly)Divide one set into several subsets.
 * Use shuffle to pick random data.
 ...
 */
function parseDataFromKaoriFormat2RSCFormatMultipleChunkBlock($szFPInputFN, $szDataOutputDir, $szAnnOutputDir, $szDataName, $nMaxSamplesPerBlock = 50000, $nMaxBlocksPerChunk = 3, $nAnnIndex = 2)
{
    $nNumRows = loadListFile($arRawList, $szFPInputFN);
...
/**
 * Load and parse data into 2 parts: KeyFrameID & FeatureVector-Raw (i.e.
 * str, not array!!!!)
 *
